...
import {
  OverviewStats,
  OverviewStatsProps,
} from "../../domain/entities/overview-stats.entity";
import {
  RevenueTrend,
  RevenueTrendProps,
} from "../../domain/entities/revenue-trend.entity";
import {
  TopContent,
  TopContentProps,
} from "../../domain/entities/top-content.entity";
import {
  SubscriptionTrend,
  SubscriptionTrendProps,
} from "../../domain/entities/subscription-trend.entity";
...
export class AnalyticsService {
  ...
  async getTopContent(
    ...
    const cacheKey = this.cache.generateKey("top-content-v2", {
      start: dateRange.start.toISOString(),
      end: dateRange.end.toISOString(),
      limit,
      offset,
    ...
    const content = await this.repository.getTopContent(
      dateRange,
      limit,
      offset,
    );
